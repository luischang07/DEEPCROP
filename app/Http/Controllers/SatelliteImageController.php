...
class SatelliteImageController extends Controller
{
    ...
    {
        try {
            // Validación simplificada para mayor flexibilidad
            $request->validate([
            ...
            // Transformar coordenadas del frontend al formato que espera el microservicio
            ...
            if (isset($coordinates[0]) && is_array($coordinates[0])) {
                ...
                $bounds = $coordinates; // Estructura plana
            }
